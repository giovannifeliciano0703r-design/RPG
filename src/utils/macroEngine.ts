...
export const resolveMacroVariables = (rawCommand: string, sheet?: CharacterSheet | null): string => {
  ...
  const variables: Record<string, number | string> = {
    ...
    strMod: derived.strMod, dexMod: derived.dexMod, conMod: derived.conMod, intMod: derived.intMod, wisMod: derived.wisMod, chaMod: derived.chaMod,
    profBonus: derived.proficiencyBonus, pb: derived.proficiencyBonus, level: sheet.level, lvl: sheet.level, ac: derived.totalAC, ca: derived.totalAC, hp: sheet.currentHp, maxHp: derived.totalMaxHp, initiative: derived.initiative, spellSaveDC: derived.spellSaveDC, spellAttack: derived.spellAttackBonus,
  };
